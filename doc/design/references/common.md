...
[中文](common.zh.md) · [Architecture](architecture.md)
...
- [Interfaces](#interfaces)
  ...
  - [Binary, parsing, and manifest utilities](#binary-parsing-and-manifest-utilities)
  - [Runtime utilities](#runtime-utilities)
  - [Event listener contract](#event-listener-contract)
  - [IO registry and loaders](#io-registry-and-loaders)
