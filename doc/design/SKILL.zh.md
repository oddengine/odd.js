...
2. **SDK 归属：**选择 [Common](references/common.zh.md)、[Player](references/player.zh.md)、[RTC](references/rtc.zh.md)、[IM](references/im.zh.md)、[NES](references/nes.zh.md) 或 [Famicom](references/famicom.zh.md)。每个模块页都已包含接口与事件。
