...
odd.js 是面向媒体播放、实时通信、即时消息与云游戏的模块化 Web SDK 系列。它以共享浏览器基础库为底座，提供 Player、RTC、IM、Famicom 与复合型 App SDK，并将协议及运行时逻辑与可选 UI 插件分离，支持多个实例独立运行。通信、信令、媒体路由及云游戏所需的配套服务器为 [odd.d](https://github.com/oddengine/odd.d)。
