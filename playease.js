	...
	skins.def = function(config) {
		...
		function _init() {
			...
			css('.' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plleft'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plcenter'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plright'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plleft > *'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plcenter > *'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plright > *', {
				'float': 'left'
			});
			...
			css('.' + SKIN_CLASS + '.' + states.BUFFERING + ' .' + CONTROLS_CLASS + ' .plplay'
				+ ', .' + SKIN_CLASS + '.' + states.PLAYING + ' .' + CONTROLS_CLASS + ' .plplay'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .plreload'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .plalt'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plelapsed'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .pldevider'
				+ ', .' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plduration', {
				display: CSS_NONE
			});
			css('.' + SKIN_CLASS + '.' + states.BUFFERING + ' .' + CONTROLS_CLASS + ' .plpause'
				+ ', .' + SKIN_CLASS + '.' + states.PLAYING + ' .' + CONTROLS_CLASS + ' .plpause'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .plslider.time'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .plstop'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .plelapsed'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .pldevider'
				+ ', .' + SKIN_CLASS + '.' + rendermodes.VOD + ' .' + CONTROLS_CLASS + ' .plduration', {
				display: CSS_BLOCK
			});
			...
			css('.' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .' + TOOLTIP_CLASS, {
				bottom: '40px',
				position: CSS_ABSOLUTE
			});
			css('.' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .' + TOOLTIP_CLASS + '.hd', {
				'z-index': '2'
			});
			css('.' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .' + TOOLTIP_CLASS + '.hd .' + TOOLTIP_ITEM_CLASS, {
				'min-width': '40px'
			});
			css('.' + SKIN_CLASS + ' .' + CONTROLS_CLASS + ' .plhd:hover .' + TOOLTIP_CLASS + '.hd', {
				visibility: 'visible'
			});
