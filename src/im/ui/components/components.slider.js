(function (odd) {
    var utils = odd.utils,
        ...
        CLASS_SLIDER = 'im-slider',
        CLASS_SLIDER_CONTENT = 'im-slider-content',
        CLASS_TOOLTIP = 'im-tooltip',
        CLASS_SLIDER_RAIL = 'im-slider-rail',
        CLASS_SLIDER_THUMB = 'im-slider-thumb',
